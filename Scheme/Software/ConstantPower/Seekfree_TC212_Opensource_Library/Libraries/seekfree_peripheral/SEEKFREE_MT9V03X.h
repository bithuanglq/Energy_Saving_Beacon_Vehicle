...
#define MT9V03X_COF_UART_TX     UART1_TX_P15_0
#define MT9V03X_COF_UART_RX     UART1_RX_P15_1

#define MT9V03X_VSYNC_PIN       ERU_CH4_REQ8_P33_7  //场中断引脚	可选范围参考ERU_PIN_enum枚举 不可与像素引脚选择为同一个通道，或者是共用中断的通道
...
#define MT9V03X_PCLK_PIN        ERU_CH6_REQ12_P11_10//定义像素时钟引脚 可选范围参考ERU_PIN_enum枚举 不可与场中断引脚选择为同一个通道，或者是共用中断的通道
													//例如场中断选择ERU_CH3 那么像素引脚就不能选择ERU_CH7，因为3和7的中断是共用的。
