...
#define WIRELESS_UART        UART_0         //无线转串口模块 所使用到的串口
#define WIRELESS_UART_TX     UART0_TX_P14_0
#define WIRELESS_UART_RX     UART0_RX_P14_1
#define WIRELESS_UART_BAUD   115200

#define RTS_PIN P14_4 //定义流控位引脚  指示当前模块是否可以接受数据  0可以继续接收  1不可以继续接收
