...
#define TFT_SDA     SPI0_MOSI_P20_14 //定义SPI_MOSI引脚
#define TFT_SDA_IN  SPI0_MISO_P20_12 //定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define TFT_CS      SPI0_CS6_P20_10  //定义SPI_CS引脚
                    
#define BL_PIN		P20_12	        //液晶背光引脚定义 由于实际通讯未使用P15_4因此 这里复用为GPIO
#define REST_PIN	P20_7           //液晶复位引脚定义
#define DC_PIN		P20_6	        //液晶命令位引脚定义
