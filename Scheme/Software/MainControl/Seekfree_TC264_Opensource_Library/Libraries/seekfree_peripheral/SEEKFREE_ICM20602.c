...
#define SPI_SCK_PIN     SPI1_SCLK_P10_2    //接模块SCL
#define SPI_MOSI_PIN    SPI1_MOSI_P10_3    //接模块SDA
#define SPI_MISO_PIN    SPI1_MISO_P10_1    //接模块SA
#define SPI_CS_PIN      SPI1_CS6_P33_10     //接模块CSb
